...
const apiURL = "https://api.openweathermap.org/data/2.5/weather?id=5607916&units=imperial&appid=0bc9f4baea7b9d07d7e6fa8b23b2f5f6";
...
const apiForecastURL = "https://api.openweathermap.org/data/2.5/forecast?id=5607916&units=imperial&appid=0bc9f4baea7b9d07d7e6fa8b23b2f5f6";
...
fetch(townURL)
  ...
  .then(function (jsonObject) {
    ...
    for (let i = 0; i < towns.length; i++) {
      if (towns[i].name == "Soda Springs" ) {       //select the town to be displayed
