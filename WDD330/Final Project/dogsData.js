...
if(strUser === dogsData[i].breed){
    ...
    document.querySelector('p.weight').textContent = dogsData[i].weight;
    document.querySelector('p.lifespan').textContent = dogsData[i].lifespan;
    document.querySelector('p.colors').textContent = dogsData[i].colors;
